...
export const CardPost = () => {
    return (
        <div className="grid grid-cols-[223px_1fr]">
            ...
            <div className="p-3 grid gap-2.5 bg-main-blue rounded-r-lg">
                <TitleBlock>Заголовок статьи </TitleBlock>
                <BaseText>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut lab
                    labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut lab
                    labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut lab
